...
#include "CONSTANTS.H"
      ...
      subroutine COMPUTE_MAPPED_DIFFUSION_COEFFICIENTS_2D(
     &           iboxlo0,iboxlo1
     &           ,iboxhi0,iboxhi1
     &           ,n
     &           ,inlo0,inlo1
     ...
     &           ,nncomp
     &           ,d_tensor
     &           ,id_tensorlo0,id_tensorlo1
     &           ,id_tensorhi0,id_tensorhi1
     &           ,nd_tensorcomp
     &           ,njinverse
     ...
     &           inlo1:inhi1,
     &           0:nncomp-1)
      integer nd_tensorcomp
      integer id_tensorlo0,id_tensorlo1
      integer id_tensorhi0,id_tensorhi1
      REAL_T d_tensor(
     &           id_tensorlo0:id_tensorhi0,
     &           id_tensorlo1:id_tensorhi1,
     &           0:nd_tensorcomp-1)
     ...
     &       coef_mat(0:CH_SPACEDIM-1,0:CH_SPACEDIM-1)
      ...
      do i = iboxlo0,iboxhi0
...
#if CH_SPACEDIM==3
         d_mat(0,0) = d_tensor(i,j,0)
         d_mat(0,1) = d_tensor(i,j,1)
         d_mat(0,2) = d_tensor(i,j,2)
         d_mat(1,0) = d_tensor(i,j,3)
         d_mat(1,1) = d_tensor(i,j,4)
         d_mat(1,2) = d_tensor(i,j,5)
         d_mat(2,0) = d_tensor(i,j,6)
         d_mat(2,1) = d_tensor(i,j,7)
         d_mat(2,2) = d_tensor(i,j,8)
         ...
         d_mat(0,0) = d_tensor(i,j,0)
         d_mat(0,1) = d_tensor(i,j,1)
         d_mat(1,0) = d_tensor(i,j,2)
         d_mat(1,1) = d_tensor(i,j,3)
         nji_mat(0,0) = njinverse(i,j,0)
         nji_mat(0,1) = njinverse(i,j,1)
